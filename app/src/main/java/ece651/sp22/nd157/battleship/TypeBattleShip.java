...
public class TypeBattleShip<T> extends BasicShip<T> {
  ...
  public TypeBattleShip(String name,Coordinate upperLeft,Character orientation, ShipDisplayInfo<T> myDisplayInfo, ShipDisplayInfo<T> enemDisplayInfo) {
    /**
  ...
  static HashMap<Integer,Coordinate> makeCoords(Coordinate upperLeft, Character orientation) {
     ...
     *@param orientation is the orientation of the ship, for BattleShip'U','D','L','R'
